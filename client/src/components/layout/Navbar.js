    ...
    <div>
        ...
        <div className="collapse navbar-collapse mt-1" id="navbarNav">
            ...
            <span className="nav-item">
                <a className="btn nav-link nav-link-bg-50 font-weight-bold float-right"onClick={logout} href='#!'>Logout</a>
            </span>
        </div>
    </div>
  );
...
const guestLinks = (
    <div>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <span className="nav-item">
                <Link className="btn nav-right nav-link-bg-50 py-2 font-weight-bold" to='/login'>Login</Link>
            </span>
        </div>
    </div>
);
